...
public class GenerateJava extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/org/eclipse/ocl/examples/build/acceleo/generateJava";
	...
	public void initialize(URI modelURI, File folder, List<?> arguments) throws IOException {
		...
		if (model instanceof Pivotable) {
			model = ((Pivotable)model).getPivot();
		}
	}
