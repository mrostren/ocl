...
public class PivotExecutorOperation extends ExecutorOperation
{
	...
	public PivotExecutorOperation(ExecutorClass evaluationClass, int operationIndex, Operation pivotOperation) {
		super(pivotOperation.getName(), evaluationClass, operationIndex, pivotOperation.getImplementation());
