...
public class PivotExecutorClass extends ExecutorClass
{
	...
	public PivotExecutorClass(PivotExecutorPackage evaluationPackage, PivotExecutorFragment[] fragments, org.eclipse.ocl.examples.pivot.Class pivotClass) {
		super(pivotClass.getName(), evaluationPackage, fragments, null);
