...
public interface LibraryIterate extends LibraryFeature
{
	 ...
	 */
	Value evaluate(DomainEvaluator evaluator, DomainType returnType, CollectionValue sourceVal, DomainTypedElement accumulator, Value initValue, DomainExpression body, DomainTypedElement... iterators) throws InvalidEvaluationException, InvalidValueException;
}
