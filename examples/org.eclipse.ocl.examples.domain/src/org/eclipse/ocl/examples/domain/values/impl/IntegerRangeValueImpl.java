...
//	private Type type = null;
	...
	public IntegerRangeValueImpl(ValueFactory valueFactory, DomainCollectionType type, int first, int last) {
		super(valueFactory, type, new IntegerRangeImpl(valueFactory, first, last));
	}
