...
//	public static SetValue valueOfElements(ValueFactory valueFactory, CollectionValueType type, Collection<? extends Element> elements) {
//		Set<Value> results = new HashSet<Value>();
//		for (Element element : elements) {
//			results.add(valueFactory.createElementValue(type.getElementType(), element));
//		}
//		return new SetValueImpl(valueFactory, type, results);
//	}

//	public static SetValue valueOfObjects(ValueFactory valueFactory, CollectionValueType type, Collection<? extends Object> objects) {
//		Set<Value> results = new HashSet<Value>();
//		for (Object object : objects) {
//			results.add(valueFactory.createObjectValue(type.getElementType(), object));
//		}
//		return new SetValueImpl(valueFactory, type, results);
//	}
