...
import org.eclipse.ocl.examples.debug.util.ASTUtil;
...
public class FrameStack {
	...
	public FrameStack() {
		...
		builtInVariables.put("null", ASTUtil.createReadOnlyVariable("null", null));
	}
	 ...
	 * @param entryPoint
	 *            The DomainExpression from which the entry is performed
	 * @param variables
	 *            Zero or more variables that will be added to the new frame.
	 */
	public Frame enterGlobal(FrameType type, DomainExpression entryPoint, Variable... variables) {
	 ...
	 * @return
	 */
	public Frame enterLocal(FrameType type, DomainExpression entryPoint, Variable... variables) {
	 ...
	 * Enters a new local frame.
	 *
	 * @deprecated Use {@link #enterLocal(FrameType, DomainExpression, Variable...)} instead.
	 *             This method will be removed from a future version of Epsilon.
	 */
	public Frame enter(FrameType type, DomainExpression entryPoint, Variable... variables) {
	 ...
	 * {@link #leaveGlobal(DomainExpression, boolean)} for that.
	 */
	public void leaveLocal(DomainExpression entryPoint, boolean dispose) {
		locals.leave(entryPoint, dispose);
	}
	
	/**
	 * Convenience method for {@link #leaveLocal(DomainExpression, boolean))} which disposes of the stack
	 * frame that was left.
	 */
	public void leaveLocal(DomainExpression entryPoint) {
	 ...
	 * {@link #leaveLocal(DomainExpression, boolean)} for that. This method will not leave the
	 * last remaining global stack frame.
	 */
	public void leaveGlobal(DomainExpression entryPoint, boolean dispose) {
		if (countGlobalFrames() > 1)
			globals.leave(entryPoint, dispose);
	}
	
	/**
	 * Convenience method for {@link #leaveGlobal(DomainExpression, boolean)} which disposes of the
	 * global stack frame that was left.
	 */
	public void leaveGlobal(DomainExpression entryPoint) {
	 ...
	 * stack.
	 * 
	 * @deprecated Use {@link #leaveLocal(DomainExpression, boolean)} instead.
	 *             This method will be removed from a future version of Epsilon.
	 */
	public void leave(DomainExpression entryPoint, boolean dispose) {
		leaveLocal(entryPoint, dispose);
	}
	
	/**
	 * Convenience method for {@link #leaveLocal(DomainExpression)} which disposes of the stack
	 * frame that was left.
	 * 
	 * @deprecated Use {@link #leaveLocal(DomainExpression)} instead.
	 *             This method will be removed from a future version of Epsilon.
	 */
	public void leave(DomainExpression entryPoint) {
		leaveLocal(entryPoint, true);
	}
	 ...
	 *             (e.g. {@link #enterGlobal(FrameType, DomainExpression, Variable...)},
