 ...
 ******************************************************************************/
package org.eclipse.ocl.examples.debug.execute;
...
import org.eclipse.ocl.examples.debug.execute.control.DefaultExecutionController;
import org.eclipse.ocl.examples.debug.execute.control.EolRuntimeException;
import org.eclipse.ocl.examples.debug.execute.control.ExecutionController;
...
//	protected HashMap<Integer, AbstractExecutor> executorCache = new HashMap<Integer, AbstractExecutor>();
	protected DomainExpression activeAst = null;
...
/*	public Object executeBlockOrExpressionAst(DomainExpression ast, IEolContext context, Class<?> returnType, Object default_) throws EolRuntimeException {
...
/*	public Object executeBlockOrExpressionAst(DomainExpression ast, IEolContext context) throws EolRuntimeException {
...
/*	public Object executeBlockOrExpressionAst(DomainExpression ast, IEolContext context, Object default_) {
...
/*	public Object executeAST(DomainExpression ast, IEolContext context, boolean asStatement) throws EolRuntimeException {
...
/*	public Object executeAST(DomainExpression ast, IEolContext context) throws EolRuntimeException{
	...
	public DomainExpression getActiveAst() {
		return activeAst;
	}
