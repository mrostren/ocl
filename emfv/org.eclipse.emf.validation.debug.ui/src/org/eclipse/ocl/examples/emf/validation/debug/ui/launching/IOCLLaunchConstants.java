package org.eclipse.ocl.examples.emf.validation.debug.ui.launching;

public interface IOCLLaunchConstants {
	String PREFIX = "org.eclipse.ocl.examples.validity.debug.";  //$NON-NLS-1$
	
    String OCL_FILE   = PREFIX + "oclFile"; //$NON-NLS-1$
