 ...
 * </copyright>
 */
package org.eclipse.ocl.examples.emf.validation.debug.ui.export.util;
...
public class TextExport extends AbstractExport {
	...
	public String createContents(@NonNull IResource validatedResource, RootNode rootNode, IFile exportedFile) {
		...
		text.append("\t\t\t\t" + validatedResource.getName() + "\n");
		text.append("\n");
		text.append("\n");
		text.append("==== METRICS ====\n");
	...
	private void appendLogFile(LeafConstrainingNode node, StringBuilder s,
		...
		String expression = node.getConstraintDefinition().getExpression();
		if (expression != null) {
