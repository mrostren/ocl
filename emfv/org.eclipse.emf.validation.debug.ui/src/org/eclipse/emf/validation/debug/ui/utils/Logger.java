 ...
 *******************************************************************************/
package org.eclipse.emf.validation.debug.ui.utils;
        ...
        return new java.util.logging.Logger(id, null) {
			...
			public void log(LogRecord record) {
            	if(EMFPlugin.IS_ECLIPSE_RUNNING) {
	                ILog pluginLog = ValidityUIPlugin.getPlugin().getLog();
	                IStatus status = new Status(getStatusSeverity(record.getLevel()), ValidityUIPlugin.PLUGIN_ID, 1, record.getMessage(), record.getThrown());
