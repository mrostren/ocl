 ...
 *******************************************************************************/
package org.eclipse.emf.validation.debug.ui.launching;
...
public class ValidityLauncherTab extends AbstractLaunchTab
{    
...
//            myTraceNameNonChanged = myTraceFile.getText().equals(getTraceFileName());
    ...
    public ValidityLauncherTab(ResourceSet validationRS) {
...
//		doValidation();
	...
	private void showError(String title, String message, Exception e) {
		IStatus status = new Status(Status.ERROR, ValidityUIPlugin.PLUGIN_ID, message, e);
...
/*        try {
    ...
    private final ISetMessage SET_MESSAGE = new ISetMessage() {
        public void setErrorMessage(String message) {
        	ValidityLauncherTab.this.setErrorMessage(message);
        }

        public void setMessage(String message) {
        	ValidityLauncherTab.this.setMessage(message);
        }
    };
}
