 ...
 * <ul>
 *   <li>{@link org.eclipse.ocl.examples.emf.validation.debug.validity.ResultValidatableNode#getResultConstrainingNode <em>Result Constraining Node</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.eclipse.ocl.examples.emf.validation.debug.validity.ValidityPackage#getResultValidatableNode()
 * @model
 * @generated
 */
public interface ResultValidatableNode extends ValidatableNode {
	 ...
	 * It is bidirectional and its opposite is '{@link org.eclipse.ocl.examples.emf.validation.debug.validity.ResultConstrainingNode#getResultValidatableNode <em>Result Validatable Node</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.eclipse.ocl.examples.emf.validation.debug.validity.ValidityPackage#getResultValidatableNode_ResultConstrainingNode()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.ocl.examples.emf.validation.debug.validity.ResultValidatableNode#getResultConstrainingNode <em>Result Constraining Node</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
