package org.eclipse.ocl.examples.emf.validation.debug.launching;
...
public class ValidityLaunchConfigurationDelegate extends LaunchConfigurationDelegate {
...
//    private static final IStatus fgLaunchErrorStatus = new Status(IStatus.ERROR, QvtRuntimePlugin.ID, LAUNCH_ERROR_CODE, "Launch configuration error", null); //$NON-NLS-1$	
	...
	public ValidityLaunchConfigurationDelegate() {
	}
