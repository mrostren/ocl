...
import org.eclipse.ocl.examples.emf.validation.debug.validity.ResultSet;
 ...
 * <ul>
 *   <li>{@link org.eclipse.ocl.examples.emf.validation.debug.validity.impl.ResultImpl#getResultSet <em>Result Set</em>}</li>
 *   <li>{@link org.eclipse.ocl.examples.emf.validation.debug.validity.impl.ResultImpl#getResultValidatableNode <em>Result Validatable Node</em>}</li>
 *   <li>{@link org.eclipse.ocl.examples.emf.validation.debug.validity.impl.ResultImpl#getSeverity <em>Severity</em>}</li>
 *   <li>{@link org.eclipse.ocl.examples.emf.validation.debug.validity.impl.ResultImpl#getDiagnostic <em>Diagnostic</em>}</li>
 *   <li>{@link org.eclipse.ocl.examples.emf.validation.debug.validity.impl.ResultImpl#getValidatableNode <em>Validatable Node</em>}</li>
 *   <li>{@link org.eclipse.ocl.examples.emf.validation.debug.validity.impl.ResultImpl#getLeafConstrainingNode <em>Leaf Constraining Node</em>}</li>
 *   <li>{@link org.eclipse.ocl.examples.emf.validation.debug.validity.impl.ResultImpl#getResultConstrainingNode <em>Result Constraining Node</em>}</li>
 *   <li>{@link org.eclipse.ocl.examples.emf.validation.debug.validity.impl.ResultImpl#getException <em>Exception</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
